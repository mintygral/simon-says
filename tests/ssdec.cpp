...
int main(int argc, char **argv, char **env)
{
  ...
  Vssdec *ssdec = new Vssdec; // Or use a const unique_ptr, or the VL_UNIQUE_PTR wrapper
  ...
  for(int i = 0; i < 16; i++) {
    ...
    std::cout << "out value: " << std::to_string(ssdec->out & 0x7F);
    std::cout << ", expected: " << std::to_string(expected) << "\n";

    switch (expected) {
      case  0: passed_subtests += ((ssdec->out & 0x7F) == 63)   ? 1 : 0; break;
      case  1: passed_subtests += ((ssdec->out & 0x7F) == 6)   ? 1 : 0; break;
      case  2: passed_subtests += ((ssdec->out & 0x7F) == 91)  ? 1 : 0; break;
      case  3: passed_subtests += ((ssdec->out & 0x7F) == 79)  ? 1 : 0; break;
      case  4: passed_subtests += ((ssdec->out & 0x7F) == 102) ? 1 : 0; break;
      case  5: passed_subtests += ((ssdec->out & 0x7F) == 109) ? 1 : 0; break;
      case  6: passed_subtests += ((ssdec->out & 0x7F) == 125) ? 1 : 0; break;
      case  7: passed_subtests += ((ssdec->out & 0x7F) == 7)   ? 1 : 0; break;
      case  8: passed_subtests += ((ssdec->out & 0x7F) == 127) ? 1 : 0; break;
      case  9: passed_subtests += ((ssdec->out & 0x7F) == 103) ? 1 : 0; break;
      case 10: passed_subtests += ((ssdec->out & 0x7F) == 119) ? 1 : 0; break;
      case 11: passed_subtests += ((ssdec->out & 0x7F) == 124) ? 1 : 0; break;
      case 12: passed_subtests += ((ssdec->out & 0x7F) == 57)  ? 1 : 0; break;
      case 13: passed_subtests += ((ssdec->out & 0x7F) == 94)  ? 1 : 0; break;
      case 14: passed_subtests += ((ssdec->out & 0x7F) == 121) ? 1 : 0; break;
      case 15: passed_subtests += ((ssdec->out & 0x7F) == 113) ? 1 : 0; break;
    }
    total_subtests++;
  }
  ...
  ssdec->enable = 0;
  ssdec->eval();
  passed_subtests += (ssdec->out == 0) ? 1 : 0;
  total_subtests++;
